...
library(rms)
setwd("/Users/jlu/Desktop/Pro_Mine/Paper_TCGA_2/data_in/add_nomo/")                         
...
pdf(file="nomogram.calibration_add.pdf",height=7,width=7)
...
write.table(outTab,file="tcga.AUC.Quantify_add.txt",sep="\t",row.names=F,quote=F)
