...
pdf(file="gg.nomogram.calibration.pdf",height=7,width=7)
...
outFile2="gg.tcga.AUC.Quantify.pdf"
...
write.table(outTab,file="gg.tcga.AUC.Quantify.txt",sep="\t",row.names=F,quote=F)
